...
<body>
    ...
    <div id="github-repo-info">
        <p>Cliquez <a href="MAJ/Dernière_maj/">ici</a> pour lire les denières mises à jour de notre site web et <a href="MAJ/All_maj/">ici</a> pour lire l'ensemble des mises à jour.</p>
    </div>    
    <div class="game-list">
        <div class="game">
...
<script>
    const accessToken = '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'; // Remplacez par votre propre jeton d'accès
    ...
    .then(data => {
        ...
        const markdownText = `# Dernière version de ${repoName}\n\n${data.body}`;
        const htmlContent = marked(markdownText);
        repoInfo.innerHTML = htmlContent;
    })
    .catch(error => {
        console.error('Erreur lors de la récupération des informations du dépôt GitHub', error);
    });
</script>
